defmodule Rumbl.AuthTest do
  ...
  test "autheticate_user continues when the current_user exists", %{conn: conn} do
    conn = 
      conn
  ...
  test "login saves the user_id in the session", %{conn: conn} do
    login_conn =
      conn
  ...
  test "logout removes the user_id from the session", %{conn: conn} do
    logout_conn =
      conn
